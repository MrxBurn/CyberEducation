...
class Keys {
  ...
  static final key12 = GlobalKey();
  static final key13 = GlobalKey();
  static final key14 = GlobalKey();
  static final key15 = GlobalKey();
}
...
class _QuizState extends State<Quiz> {
  ...
  void addNewScore() {
    ...
    if (QuizNumber.isFirstQuiz == true) {
      colRef.doc(userID).update({
        'score_one': Score.score,
      });
    } else {
      colRef.doc(userID).update({
        'score_two': Score.score,
      });
    }
  }
                ...
                child: Column(
                  children: [
                    ...
                    Questions(
                      ...
                      question: '8. How do you protect yourself from viruses?',
                      answer1:
                    ...
                    OnlineBehaviour(
                      key: Keys.key11,
                      moveToWidget: Keys.key12,
                      backColor: Color(0xff6cac9c),
                      behaviourQuestion:
                    ...
                    OnlineBehaviour(
                      key: Keys.key12,
                      moveToWidget: Keys.key13,
                      backColor: Color(0xff384d78),
                      behaviourQuestion:
                          '12. I like posting stuff on social media to socialise with my friends',
                      explanation: 'While it may seem like'
                    ...
                    OnlineBehaviour(
                      key: Keys.key13,
                      moveToWidget: Keys.key14,
                      backColor: Color(0xffe36b77),
                      behaviourQuestion:
                          '13. I have a lot of accounts, thus I am using a notebook to write them down',
                      explanation: 'Anyone can take your notebook '
                    ...
                    OnlineBehaviour(
                      key: Keys.key14,
                      moveToWidget: Keys.key15,
                      backColor: Color(0xff023047),
                      behaviourQuestion:
...
class _QuestionsState extends State<Questions> {
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
        ...
        child: Container(
            width: 500,
            height: media.width > 600 ? 650 : media.height,
            decoration: BoxDecoration(
              ...
              children: [
                Align(
                    ...
                    child: Padding(
                        ...
                        child: Container(
                            width: 700,
                            height: media.width >= 600 ? 370 : 350,
                            decoration: BoxDecoration(
                              boxShadow: [
                                BoxShadow(
...
class OnlineBehaviour extends StatefulWidget {
  ...
  OnlineBehaviour({
    ...
    required this.behaviourQuestion,
...
class _OnlineBehaviourState extends State<OnlineBehaviour> {
  ...
  void scrollPage() {
    Scrollable.ensureVisible(widget.moveToWidget.currentContext!,
